...
class ForecastConfig:
    ...
    TIME_FORMAT = "%H:%M"
    DATE_FORMAT = "%Y-%m-%d"
    LOCALE = "BRXX0050" # with no setting the default locale of the system is used
    XOAP_PARTNER_ID = "1172178248" # need config with correct partner id
    XOAP_LICENCE_KEY = "43522b7278f1a561" # need config with correct licence key
    DEFAULT_LOCATION = "BRXX0050"
    MAXIMUM_DAYS_FORECAST = 7
    AUTO_NIGHT = False
    BASE_XOAP_URL = "http://xoap.weather.com/weather/local/BRXX0050?cc=*&dayf=10&link=xoap&prod=xoap&par=1172178248&key=43522b7278f1a561&unit=m"
    PROXY_HOST = None
    PROXY_PORT = 8080
    PROXY_USERNAME = None
    PROXY_PASSWORD = None
